...
const InteriorLayout = ({ children }: InteriorLayoutProps) => {
  return (
    <>
      <main className="grid-col-12 grid min-h-screen gap-x-5 bg-silverTree dark:bg-nileBlue">
        <aside className="col-spam-4 pb-10">
          <div className="fixed z-50">
            <Nav />
          </div>
          <img src="/images/bg__interior.svg" alt="Holiday Ilustration" />
          <a href="#">
            <img
